...
##LAB-3 ASSIGNMENT
# 1. Write a python program that calculates the Greatest Common Divisor (GCD) of two
# integers. The program should handle both positive and negative numbers. The
# program should:
# ○ Prompt the user to enter two integers
# ○ Then calculate the GCD.
# ○ Display the GCD.
